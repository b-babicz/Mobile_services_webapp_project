...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="77">
    ...
    <div class="container">
        ...
        <?php if(Auth::check() && Auth::user()->role_id == 1): ?>
            <a href="<?php echo e(route('offers.create')); ?>" class="btn btn-primary mb-3">Dodaj ofertę</a>
        <?php endif; ?>
            ...
            <tbody>
                <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($offer->product_name); ?></td>
                        <td><?php echo e($offer->monthly_cost); ?></td>
                        <td><?php echo e($offer->additional_cost); ?></td>
                        <td><?php echo e($offer->internet_package_quantity); ?></td>
                        <td><?php echo e($offer->sms_quantity); ?></td>
                        <td><?php echo e($offer->mms_quantity); ?></td>
                        <td><?php echo e($offer->calls_quantity); ?></td>
                        <td><?php echo e($offer->internet_speed); ?></td>
                        <td><?php echo e($offer->roaming_available ? 'Tak' : 'Nie'); ?></td>
                        <td>
                            <?php if(Auth::check() && Auth::user()->role_id == 1): ?>
                                <a href="<?php echo e(route('offers.edit', $offer->id)); ?>" class="btn btn-sm btn-primary">Edytuj</a>
...
<?php /**PATH /home/bartek/Desktop/laravel/laravel/resources/views/offers/index.blade.php ENDPATH**/ ?>