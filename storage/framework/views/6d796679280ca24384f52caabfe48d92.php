    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text"><?php echo e($offerCount); ?></p>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text"><?php echo e($ordersLast7DaysCount); ?></p>
            </div>
        </div>
...
<?php /**PATH /home/bartek/Desktop/laravel/laravel/resources/views/admin_center.blade.php ENDPATH**/ ?>